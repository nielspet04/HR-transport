...
'''
MODES=('DEFAULT','AUTO','BIKE','TRAIN','COMPANY_CAR','MOBILITY_BUDGET','TELEWORK')
...
def save(store,data,revision):
    ...
    if mode not in MODES:raise ValueError('Kies standaard, auto, fiets, trein, dienstwagen, mobiliteitsbudget of telework.')
